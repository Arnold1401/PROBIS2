...
$query = "SELECT * FROM djual d, barang b, hjual h WHERE (d.id_djual LIKE '%".$search."%' OR d.kuantiti LIKE '%".$search."%' OR d.id_barang LIKE '%".$search."%' OR b.nama_barang LIKE '%".$search."%' OR d.id_ulasan LIKE '%".$search."%') and d.id_barang=b.id_barang and h.id_hjual=d.id_hjual and d.id_hjual='$getId'";
