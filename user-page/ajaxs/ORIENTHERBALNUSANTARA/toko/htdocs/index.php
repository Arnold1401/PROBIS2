...
?>
  ...
  <!-- End feature Area -->
    ...
    <!--================ Supplement Product Area =================-->
    <section class="inspired_product_area section_gap_bottom_custom">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="main_title">
            <h2><span>Memelihara Kesehatan</span></h2>
          </div>
        </div>
      </div>

      <div class="row" id="tampung_mk">
  ...
  <!--================ End Inspired Product Area =================-->
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="main_title">
            <h2><span>Rekomendasi Hari ini untuk Anda</span></h2>
          </div>
        </div>
      </div>

      <div class="row" id="tampung_transaksi">
      
      </div>
    </div>
  </section>
  <!--================ End Merek Product Area =================-->
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="main_title">
            <h2><span>Rekomendasi Kesukaan Anda</span></h2>
          </div>
        </div>
      </div>

      <div class="row" id="tampung_wishlist">
