...
$query = "SELECT * FROM djual d, barang b WHERE (d.id_hjual LIKE '%".$search."%' OR d.id_djual LIKE '%".$search."%' OR b.nama_barang LIKE '%".$search."%' OR d.kuantiti LIKE '%".$search."%' OR d.subtotal LIKE '%".$search."%') and id_hjual='$getIdHjual' and d.id_barang=b.id_barang";
