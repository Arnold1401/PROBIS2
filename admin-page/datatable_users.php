...
$query = "SELECT * FROM customer c, alamat_pengiriman al WHERE (c.nama_perusahaan LIKE '%".$search."%' OR c.email LIKE '%".$search."%' OR c.nama_pemilik LIKE '%".$search."%' OR c.nomor_ktp LIKE '%".$search."%') and c.email=al.email";
